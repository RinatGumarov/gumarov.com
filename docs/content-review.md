...
| Personal-strip photo frames were empty placeholders. Rinat approved six of his own photographs (surf, skate, snowboard, powder, and two drift frames of his BMW E30) on 2026-08-15; no stock or generated images were used. Frame opacity was raised from `0.34` to `0.78` so the night skate frame reads, and the strip now runs two rows of three. | Resolved    |
...
3. Hero portrait crop, and the six approved personal photographs with their crops and localized alt text. The two drift photographs carried event photographers' credit bars; Rinat confirmed he may publish them and asked for the bars to be cropped out.
